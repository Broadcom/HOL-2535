...
# special version for 2535 26-July 2024
import datetime
import os
import sys
...
# initial port test is good now reboot esx-01a and esx-02a
reboothosts = ['esx-01a.vcf.sddc.lab', 'esx-02a.vcf.sddc.lab']
for hostname in reboothosts:
    lsf.write_output(f'Rebooting {hostname}')
